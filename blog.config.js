...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '萌主', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '天下萌萌主', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://moe.ikun.su/', // 网站地址
  ...
  // 文章URL前缀
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX ?? 'moe',
